namespace brinux.ohnosolver
{
    public class OhNoCellSolver
    {
        ...
        public void FillAllCellAvailabilities(OhNoCellCoordinate cell, Dictionary<OhNoDirectionEnum, OhNoCellMoves> availabilities)
        {
        ...
        public bool ExpandCell(OhNoCellCoordinate currentCell, int fullCellsTotal, Dictionary<OhNoDirectionEnum, OhNoCellMoves> availabilities)
        {
            var result = false;
        ...
        public bool ExpandCellInDirection(OhNoCellCoordinate currentCell, int fullCellsTotal, OhNoDirectionEnum direction, Dictionary<OhNoDirectionEnum, OhNoCellMoves> availabilities)
        {
            var result = false;
        ...
        public bool AddFinalBlocks(OhNoCellCoordinate cell)
        {
            var result = false;
        ...
        public bool AddFinalBlockInDirection(OhNoDirectionEnum direction, OhNoCellCoordinate startingCell)
        {
            var result = false;
        ...
        public bool AddMissingBlocks(OhNoCellCoordinate cell, int totalCount)
        {
            var result = false;
        ...
        public bool AddMissingBlockInDirection(OhNoDirectionEnum direction, OhNoCellCoordinate startingCell, int totalCount)
        {
            var result = false;
        ...
        public Dictionary<OhNoDirectionEnum, OhNoCellMoves> CountAvailableCells(OhNoCellCoordinate startingCell, int currentCellsCount)
        {
        ...
        public OhNoCellMoves CountAvailableCellsInDirection(OhNoDirectionEnum direction, OhNoCellCoordinate startingCell, int currentCellsCount)
        {
            var cell = startingCell;
        ...
        public Dictionary<OhNoDirectionEnum, int> CountSequenceLengths(OhNoCellCoordinate cell)
        {
        ...
        public int CountSequenceLengthInDirection(OhNoDirectionEnum direction, OhNoCellCoordinate cell)
        {
